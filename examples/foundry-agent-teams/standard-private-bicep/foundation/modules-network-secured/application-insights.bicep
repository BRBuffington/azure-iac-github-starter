...
@description('Composed workload-region-environment name base.')
...
param logAnalyticsName string = 'log-${resourceNamePrefix}-${suffix}'

@description('Name of the Application Insights component to create.')
param appInsightsName string = 'appi-${resourceNamePrefix}-${suffix}'
