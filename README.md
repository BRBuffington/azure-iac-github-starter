...
| `examples/azure-ai-infrastructure/` | Infrastructure-only deployment checklist and two sanitized Terraform roots: optional workload spoke and private Foundry foundation, with an example-specific internal GitLab HTTP state contract. |
