...
| `examples/cross-tenant-private-link-dns/` | Catalog of two independent client-agnostic Terraform roots: standard resolution contexts and prefixed backing zones. Each has its own providers, lockfile, inputs, tests, and manual-approval cross-tenant Storage DFS/Blob and Azure SQL Private Endpoints. |
